...
namespace inconsistenciasventaspsamAPI.DBContext
{
    public partial class Documento
    {
        public Documento()
        {
            ...
            DocumentoIntegrals = new HashSet<DocumentoIntegral>();
        }
